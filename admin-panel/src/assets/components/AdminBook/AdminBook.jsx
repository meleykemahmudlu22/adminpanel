...
const AdminBook = () => {
  ...
  async function updateBook() {
    ...
    try {
      ...
      await axios.put(
        `https://678e58c7a64c82aeb1200f8c.mockapi.io/new/${editId}`,
        {
          mehsul: editTitle,
          image: editimage
        }
                      ...
                      edit && (
                        <div className="edirdropdown">
                          ...
                          <div className="editdiv">
                            <h2>Edit book</h2>
                            <input value={editTitle} onChange={(e) => setEdittitle(e.target.value)} placeholder="kitabın adı" type="text" />
                            <input placeholder="author" type="text" />
                            <input onChange={(e) => setEditimage(e.target.value)} value={editimage} placeholder="image" type="text" />
                            <input placeholder="plane" type="text" />
                            <button onClick={updateBook}>Add</button>
                          </div>
                        </div>
                      )
                    }
